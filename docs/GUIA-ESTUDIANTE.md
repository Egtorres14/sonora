...
Sonora analiza tu proyecto de audio en el navegador y se lo muestra a tu profesor con las mediciones y tu sinopsis. Esta guía también está dentro de la app, en **Guía de uso**.
...
- Consejos técnicos que la app comprueba:
  ...
  - Pon **fundidos** cortos en cada corte. Los clics y saltos se detectan y penalizan.
...
Si tu profesor lo ha permitido, puedes pedir una vez por entrega una lectura de un modelo de IA: qué se oye, fortalezas y mejoras. No es una nota ni sustituye la revisión del profesor. Se envían las mediciones y tu sinopsis, nunca el audio.
