...
const TEACHER_STEPS: Step[] = [
  ...
  { title: 'Ajusta la rúbrica', text: 'En Rúbrica puedes cambiar puntos, penalizaciones y herramientas obligatorias. Las notas de toda la biblioteca se recalculan con la rúbrica vigente.', tip: 'Escribe el formato del nombre de archivo como en el enunciado, por ejemplo «{estudiante}_ejercicio{numero}», y pruébalo en la caja de al lado antes de guardar. El estudiante lo verá antes de subir.' },
...
const STUDENT_STEPS: Step[] = [
  ...
  { title: 'Prepara el archivo', text: 'Exporta tu proyecto en WAV, AIFF o FLAC (no MP3). Ponle el nombre que pida tu profesor: si hay un formato exigido, aparece en la pantalla de entrega con un ejemplo hecho con tu nombre. Máximo 200 MB.', tip: 'Deja al menos 1 dB de margen por debajo de 0 dBFS y evita cortes sin fundido: la app los detecta.' },
